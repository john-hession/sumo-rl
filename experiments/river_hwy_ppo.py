...
env = SumoEnvironment(
    net_file="sumo-rl/nets/riverhwy/osm.net.xml", # still need to add the version with john's net
    route_file="sumo-rl/nets/riverhwy/osm.rou.xml",
    single_agent=True,
    out_csv_name="outputs/river_hwy/ppo",
    use_gui=False,
    num_seconds=3000,
    yellow_time=4,
    min_green=20,
